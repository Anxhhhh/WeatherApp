...
// Mobile-optimized weather condition changer
export default function MobileOptimizedWeatherChanger({ currentCondition, onConditionChange }) {
  const conditions = [
  ...
  return (
    <>
      ...
      <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-20 sm:hidden">
        <div className="bg-black bg-opacity-40 backdrop-blur-md rounded-2xl p-2">
              ...
              <button
                ...
                className={`relative p-3 rounded-xl transition-all duration-200 active:scale-95 ${
                  currentCondition === condition.id
                    ...
                    : 'bg-white bg-opacity-10 active:bg-opacity-20'
                }`}
